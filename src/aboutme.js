...
export default function AboutMe() {
  return (
    <div className="w-full h-full md:flex  justify-between "   >
      <div className='md:w-[40%] w-[80%] mt-4 bg-slate-200 rounded-2xl px-4 right-[20px] md:mx-0  mx-auto  '>
        <h1 className="text-center text-[15px] font-bold grad2 text-slate-500 my-5">About Me </h1><hr />
        
        <div className="grad">
          <p className='text-[12px]  text-slate-500 md:text-[13px]  pl-4 pr-4  border-slate-400 text-justify'>
      ...
      <div className='md:w-[40%] w-[80%] mt-4 text-justify bg-slate-200 rounded-2xl px-4 md:mx-0 mx-auto  '>
        <h1 className='text-center text-[15px] text-slate-500 grad5 md:left-0 left-[20px] my-5 font-bold '>Another Part of Me</h1>
        <div className="grad6 md:left-0 ">
          <p className='text-[12px]  text-slate-500 md:text-[13px]  px-4  border-slate-400'>
